...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.cost'
        db.alter_column(u'HistoryPlay_place', 'cost', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Place.cost'
        db.alter_column(u'HistoryPlay_place', 'cost', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
