...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'HistoryPlay_profile', 'address',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=150),
                      keep_default=False)

        # Adding field 'Profile.user_id'
        db.add_column(u'HistoryPlay_profile', 'user_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Place.step'
        db.add_column(u'HistoryPlay_place', 'step',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'HistoryPlay_profile', 'address')

        # Deleting field 'Profile.user_id'
        db.delete_column(u'HistoryPlay_profile', 'user_id')

        # Deleting field 'Place.step'
        db.delete_column(u'HistoryPlay_place', 'step')
